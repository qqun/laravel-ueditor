...
return [
    ...
    */
    ...
    'upload' => [
        ...
        "imagePathFormat" => "/uploads/image/{yyyy}{mm}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "scrawlPathFormat" => "/uploads/image/{yyyy}{mm}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "snapscreenPathFormat" => "/uploads/image/{yyyy}{mm}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "catcherPathFormat" => "/uploads/image/{yyyy}{mm}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        "videoPathFormat" => "/uploads/video/{yyyy}{mm}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
...
//            ".webm", ".wav", ".mid",
        ...
        "filePathFormat" => "/uploads/file/{yyyy}{mm}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
